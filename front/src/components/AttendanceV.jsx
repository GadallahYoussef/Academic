                        ...
                        if (index == 0) {
                            return (
                                <div className='w-full grid grid-cols-3 items-center'>
                                    ...
                                    <div className='w-full grid grid-rows-3 justify-center items-center gap'>
                                        <div ></div>
                                        ...
                                        <div className='h-[50px] w-2 bg-[#054bb4] max-md:ml-[22px]'></div>
                                    </div>
                                    <div className='text-center'>
                            ...
                            if (index == 7) {
                                ...
                                return (
                                    <div className='w-full grid grid-cols-3 justify-center'>
                                        ...
                                        <div className='w-full grid grid-rows-3 justify-center  '>
                                            <div className='h-[50px] w-2 bg-[#054bb4] max-md:ml-[22px]'></div>
                                            <div className={`bg-white border-4 ${item[1] ? 'border-[#009E60]' : 'border-[#C70039]'} text-black w-[50px] h-[50px] text-[20px] flex items-center justify-center rounded-full max-sm:w-[50px] max-sm:h-[50px] max-sm:text-[26px] select-none z-50`}>{index+1}</div>
                                            <div className='h-[50px] w-2 bg-[#054bb4] max-md:ml-[22px]'></div>
                                        </div>
                                        <div className='flex items-center text-center'>
                                            <p className='font-bold flex-1 lg:text-[18px] md:text-[12px] text-[#054bb4]'>{index % 2 == 1 && item[0]}</p>
                                        </div>
                                    </div>
                                )
                            }
